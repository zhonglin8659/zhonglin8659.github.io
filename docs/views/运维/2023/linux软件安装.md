...
2. 实战章节中会开启多台虚拟机，请尽量确保电脑的内存在：8GB（包含8GB）以上。
...
1. 配置yum仓库
   ...
   ![image-20221012182514865](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221012182514.png)
...
2. 使用yum安装MySQL
   ...
   ![image-20221012182555420](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221012182556.png)
...
4. 检查MySQL的运行状态
   ...
   ![image-20221012182716598](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221012182716.png)
...
1. 获取MySQL的初始密码
   ...
   ![image-20221012182744115](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221012182744.png)
...
2. 登陆MySQL数据库系统
   ...
   ![image-20221012182805966](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221012182806.png)
...
7. 检查端口
   ...
   ![image-20221012183746802](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221012183746.png)
...
7. 检查端口
   ...
   ![image-20221012192303607](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221012192303.png)
...
1. 下载apt仓库文件
   ...
   ![image-20221016094103315](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016094103.png)
...
2. 配置apt仓库
   ...
   ![image-20221016094142343](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016094142.png)

   弹出框中选择：`MySQL Server & Cluster`

   ![image-20221016094216377](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016094216.png)

   弹出框中选择：`mysql-5.7`

   ![image-20221016094254397](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016094254.png)

   最后选择：`ok`

   ![image-20221016094306917](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016094306.png)
...
4. 检查是否成功配置MySQL5.7的仓库
   ...
   ![image-20221016094546943](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016094546.png)
...
5. 安装MySQL5.7
   ...
   ![image-20221016094941439](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016094941.png)

   再次输入root密码确认

   ![image-20221016094954505](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016094954.png)
...
6. 启动MySQL
   ...
   ![image-20221016095259172](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016095259.png)
...
7. 对MySQL进行初始化
   ...
   1. 输入密码：
      ...
      ![image-20221016095458755](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016095458.png)

   2. 是否开启密码验证插件，如果需要增强密码安全性，输入`y`并回车，不需要直接回车（课程中选择直接回车）

      ![image-20221016095537716](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016095537.png)

   3. 是否更改root密码，需要输入`y`回车，不需要直接回车（课程不更改）

      ![image-20221016095621386](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016095621.png)

   4. 是否移除匿名用户，移除输入`y`回车，不移除直接回车（课程选择移除）

      ![image-20221016101232827](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016101232.png)

   5. 是否进制root用户远程登录，禁止输入`y`回车，不禁止直接回车（课程选择不禁止）

      ![image-20221016101324577](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016101324.png)

   6. 是否移除自带的测试数据库，移除输入`y`回车，不移除直接回车（课程选择不移除）

      ![image-20221016101404392](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016101404.png)

   7. 是否刷新权限，刷新输入`y`回车，不刷新直接回车（课程选择刷新）

      ![image-20221016101442459](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016101442.png)
...
8. 登陆MySQL
   ...
   ![image-20221016101524498](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016101524.png)
...
9. 重新登陆MySQL（用更改后的密码）
   ...
   ![image-20221016110414182](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221016110414.png)
...
1. 下载JDK软件
   ...
   ![image-20221017163440491](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221017163440.png)

   ==在弹出的页面中输入Oracle的账户密码即可下载（如无账户，请自行注册，注册是免费的）==

2. 登陆Linux系统，切换到root用户

   ![](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221017163607.png)

3. 通过FinalShell，上传下载好的JDK安装包

   ![image-20221017163706026](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221017163706.png)
...
9. tomcat启动在8080端口，可以检查是否正常启动成功
   ...
   ![image-20221017223814737](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221017223814.png)
...
10. 打开浏览器，输入：
    ...
    ![image-20221017223915498](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221017223915.png)
...
![image-20221018143113053](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221018143113.png)
...
8. 浏览器打开管理控制台
   ...
   ![image-20221018154823983](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221018154824.png)
...
6. 测试
   ...
   ![image-20221025085432335](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025085432.png)
...
2. 新建文件夹
   ...
   ![image-20221025104157628](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104157.png)

   文件夹起名为：`虚拟机集群`

3. 克隆

   ![image-20221025104131303](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104131.png)

   ![image-20221025104312091](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104312.png)

   ![image-20221025104329109](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104329.png)

   ![image-20221025104345484](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104345.png)

   ![image-20221025104414576](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104414.png)

   ![image-20221025104427160](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104427.png)

   ![image-20221025104432927](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104432.png)

   ![image-20221025104446044](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104446.png)

4. 同样的操作克隆出：node2和node3

   ![image-20221025104825204](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025104825.png)
...
9. 验证Kafka启动
   ...
   ![image-20221025174522487](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221025174522.png)
...
![image-20221026202935745](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026202935.png)
...
![1574338996145](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175324.png)
...
![1571981197131](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175330.png)
...
![1571993951841](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175338.png)

**点击下一步，会检查相应的设置是否都正常**

![1571994018126](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175341.png)
...
![1571994069689](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175344.png)
...
![1571994111921](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175347.png)
...
![1571994206902](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175349.png)

**配置完成**

![1571994221531](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175351.png)
...
![1571994287036](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175354.png)
...
![1573635500521](https://sugarys.oss-cn-beijing.aliyuncs.com/document/linux/20221026175713.png)
